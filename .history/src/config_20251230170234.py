...
@dataclass
class Config:
    """Configuration settings for the Burton PINN training."""
    
    # --- File and Paths ---
    file_path: str = "/kaggle/input/gannon-storm/OMNI2_1min_SuperMag_coupling_Gannon_no_outliers.csv"
    result_path: str = "results/"
    storm_id: int = 176

    # --- Data Processing ---
    window_size: int = 20  # in minutes, rolling window
    y_col: str = "smr"
    q_col: str = "vBs"
