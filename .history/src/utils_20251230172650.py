...
def plot_results(history: Dict, model: torch.nn.Module,
    ...
    """Generates composite plots: Time Series Fit, Loss Curves, and Parameter Evolution."""
    ...
    # Compare PINN solution vs RK45 numerical integration
    ...
    axs[2, 1].plot(history['step'], history['a_norm'])
