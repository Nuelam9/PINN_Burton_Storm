...
### Paper (Under Review)
> Lacal, G., et al. (2025). "Physics-Informed Neural Network for Burton Equation Parameter Estimation". Submitted to *Geophysical Research Letters*.

### Software Archive (Zenodo)
> Lacal, G. (2025). pinn-burton-storm (v1.0.0). Zenodo. https://doi.org/10.5281/zenodo.XXXXX
